...
| miniRT           | <ul><li>- [ ] 작업중</li><li>- [x] 검토중</li><li>- [ ] 완료</li></ul> |  seyu   |
...
| webserv          | <ul><li>- [ ] 작업중</li><li>- [ ] 검토중</li><li>- [X] 완료</li></ul> |  wpark  |
...
5. 해당 폴더 안에 본인이 번역할 내용이 담길 파일을 만들어 주세요. 번역 첨삭의 편의성을 위해 markdown(.md)로 작성해주세요.
